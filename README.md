...
python -u scripts/bambooRunBetter.py LikelihoodRatioNew -o $Z_OUTPUT_eos/Discriminant_Study_Replica/0805_LLR_odd -lrf $Z_OUTPUT_eos/Discriminant_Study_Replica/0804_JetTop_even/lr_mapping_all_log.json -log --event_nr_sel odd -c bamboo_hh_new/config/analysis_DiscStudy.yml -d
