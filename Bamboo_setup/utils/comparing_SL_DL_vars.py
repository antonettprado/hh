...
SOURCE_DIR = 'results_reco_tests_updated3/results/'
OUT_PATH = 'Comparisons/reco/'
...
def add_signal(bbWW_sl, bbWW_dl, bbtautau, object_name, bins, h_xmin, h_xmax, titles, what_to_add):
    ...
    hist_bbWW_sl = add_chanels_and_types(object_name, bbWW_sl, bins, h_xmin, h_xmax, what_to_add)
    hist_bbWW_dl = add_chanels_and_types(object_name, bbWW_dl, bins, h_xmin, h_xmax, what_to_add)
    hist_bbtautau = add_chanels_and_types(object_name, bbtautau, bins, h_xmin, h_xmax, what_to_add)
...
def add_background(ttbar_sl, ttbar_dl, object_name, bins, h_xmin, h_xmax, titles, what_to_add):
    ...
    hist_ttbar_sl = add_chanels_and_types(object_name, ttbar_sl, bins, h_xmin, h_xmax, what_to_add)
    hist_ttbar_dl = add_chanels_and_types(object_name, ttbar_dl, bins, h_xmin, h_xmax, what_to_add)

    total = ROOT.TH1F("total_backg","", bins, h_xmin, h_xmax)
