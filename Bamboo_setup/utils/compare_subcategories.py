...
if __name__ == "__main__":
    ...
    draw1D("t1_mInv_combo_max_pt", T_BINS, T_MIN, T_MAX, ['m_{inv} (b1_jj) of top1', 'GeV', ''], 'SL', ['res_2b'])
    draw1D("t2_mT_combo_max_pt", T_BINS, T_MIN, T_MAX, ['m_{T} of top2', 'GeV', ''], 'SL', ['res_2b'])
    draw1D("t1_mInv_combo_min_pt", T_BINS, T_MIN, T_MAX, ['m_{inv} (b1_jj) of top1', 'GeV', ''], 'SL', ['res_2b'])
    draw1D("t2_mT_combo_min_pt", T_BINS, T_MIN, T_MAX, ['m_{T} of top2', 'GeV', ''], 'SL', ['res_2b'])
    draw1D("t1_mInv_combo_min_dPhi", T_BINS, T_MIN, T_MAX, ['m_{inv} (b1_jj) of top1', 'GeV', ''], 'SL', ['res_2b'])
    draw1D("t1_dPhi_combo_min_dPhi", BJETS_DPHI_BINS, BJETS_DPHI_MIN, BJETS_DPHI_MAX, ['dPhi between b and jj of top1', 'dPhi', ''], 'SL', ['res_2b'])
    draw1D("t2_mT_combo_min_dPhi", T_BINS, T_MIN, T_MAX, ['m_{inv} (b1_jj) of top1', 'GeV', ''], 'SL', ['res_2b'])
    draw1D("t2_dPhi_combo_min_dPhi", BJETS_DPHI_BINS, BJETS_DPHI_MIN, BJETS_DPHI_MAX, ['dPhi between b and lepton of top2', 'dPhi', ''], 'SL', ['res_2b'])
    ...
    draw1D("t1_mInv_combo_min_dPhi_mjj_mW", T_BINS, T_MIN, T_MAX, ['m_{inv} (b1_jj) of top1', 'GeV', ''], 'SL', ['res_2b'])
    draw1D("t1_dPhi_combo_min_dPhi_mjj_mW", BJETS_DPHI_BINS, BJETS_DPHI_MIN, BJETS_DPHI_MAX, ['dPhi between b and jj of top1', 'GeV', ''], 'SL', ['res_2b'])
    draw1D("t2_mT_combo_min_dPhi_mjj_mW", T_BINS, T_MIN, T_MAX, ['m_{T} of top2', 'GeV', ''], 'SL', ['res_2b'])
    draw1D("t2_dPhi_combo_min_dPhi_mjj_mW", BJETS_DPHI_BINS, BJETS_DPHI_MIN, BJETS_DPHI_MAX, ['dPhi between b and lepton of top2', 'GeV', ''], 'SL', ['res_2b'])

    draw2D("bjets_mbb_vs_"+"t1_mInv_combo_max_pt", BJET_PT_BINS, BJET_PT_MIN, BJET_PT_MAX, T_BINS, T_MIN, T_MAX, ['m_{inv} of t1 vs bjets m_{bb}', 'm_{bb}', 'm_{inv} of t1'], 'SL', ['res_2b'])
    draw2D("bjets_mbb_vs_"+"t1_mInv_combo_min_pt", BJET_PT_BINS, BJET_PT_MIN, BJET_PT_MAX, T_BINS, T_MIN, T_MAX, ['m_{inv} of t1 vs bjets m_{bb}', 'm_{bb}', 'm_{inv} of t1'], 'SL', ['res_2b'])
    draw2D("bjets_mbb_vs_"+"t1_mInv_combo_min_dPhi", BJET_PT_BINS, BJET_PT_MIN, BJET_PT_MAX, T_BINS, T_MIN, T_MAX, ['m_{inv} in t1 vs bjets m_{bb}', 'm_{bb}', 'm_{inv} of t1'], 'SL', ['res_2b'])
    ...
    draw2D("bjets_mbb_vs_"+"t1_mInv_combo_min_dPhi_mjj_mW", BJET_PT_BINS, BJET_PT_MIN, BJET_PT_MAX, T_BINS, T_MIN, T_MAX, ['m_{inv} of t1 vs bjets m_{bb}', 'm_{bb}', 'm_{inv} of t1'], 'SL', ['res_2b'])
