...
class SL_DL_event_selection_v3(NanoBaseHHbbWW):
    def __init__(self, args):
        super(SL_DL_event_selection_v3, self).__init__(args)
        self.event_nr_sel = "all"
        
    def addArgs(self, parser):
        super(SL_DL_event_selection_v3, self).addArgs(parser)
    ...
    @staticmethod
    def get_event_selections(tree, objects, baseSel, is_MC:bool, era:int, sample:str, noHLT=False, use_mvaTTH=False):
    ...
    @staticmethod
    def for_synchronization(tree, objects, baseSel, is_MC:bool, era:int, sample:str, noHLT=False, use_mvaTTH=False):

        selections = SL_DL_event_selection_v3.get_event_selections(tree, objects, baseSel, is_MC, era, sample, noHLT=False, use_mvaTTH=False)
    ...
    def definePlots(self, tree, baseSel, sample=None, sampleCfg=None):
        ...
        self.objects = SL_DL_event_selection_v3.get_objects(tree, self.era, self.args.mc_truth_b, use_mvaTTH=False) 
        self.selections = SL_DL_event_selection_v3.get_event_selections(tree, self.objects, baseSel, yields, self.is_MC, self.era, self.sample, noHLT=False, use_mvaTTH=False)
