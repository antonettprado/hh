...
from bamboo_hh.definitions.utils import VariableRegister
...
def data_bjets_dPhi(ctx):
    res_bjet0, res_bjet1, boost_bjet0, boost_bjet1, two_btags = ctx._get_bjets_data() # res_lbjet, use_lbtag = ctx._get_bjets_data()
...
def get_bjet0_pt(ctx):
    res_bjet0, _, boost_bjet0, _, _ = ctx._get_bjets_data()
...
def get_bjet1_pt(ctx):
    _, res_bjet1, _, boost_bjet1, two_btags = ctx._get_bjets_data()
...
#     j0, j1, bjet, trijet_defined = ctx._get_trijet_data()
...
# def get_blnu_mT(ctx)
#     l_p4, nu, bjet, blnu_defined = ctx._get_blnu_data()
...
#     l_p4, _, bjet, blnu_defined = ctx._get_blnu_data()
...
#     l_p4, nu, _, blnu_defined = ctx._get_blnu_data()
...
# def get_all_sT(ctx)
#     electrons, muons, met, jets = ctx._get_total_vars_data()
...
#     total_4vec = ctx._get_total_4vec()
#     return total_4vec.M()
...
# def get_mjj(ctx)
#     jj_W, two_nonbtags = ctx._get_jj_W()
...
#     jj_W, two_nonbtags = ctx._get_jj_W()
#     j0, j1 = jj_W[0], jj_W[1]
#     lep0_p4, lep1_p4 = ctx._get_leptons_p4()
...
#     bjet0, bjet1, _, _, two_btags = ctx._get_bjets_data()
#     lep0_p4, _ = ctx._get_leptons_p4()
#     met = ctx.objects['met']
...
#     ak4_jets, ak4_btags, ak8_btags = ctx._get_jet_objects()
...
# def get_nAK4(ctx)
#     return op.static_cast("Float_t", op.rng_len(ctx.objects["cleaned_ak4_jets"]))

# @reg(name="nAK4_btag", nbins=30, xmin=0, xmax=30, unit="", title="nAK4_btag")
# def get_nAK4_btag(ctx)
#     return op.static_cast("Float_t",op.rng_len(ctx.objects["cleaned_ak4_btags"]))

# @reg(name="nAK4_nonbtag", nbins=30, xmin=0, xmax=30, unit="", title="nAK4_nonbtag")
# def get_nAK4_nonbtag(ctx)
#     return op.static_cast("Float_t", op.rng_len(ctx.objects["cleaned_ak4_jets"]) - op.rng_len(ctx.objects["cleaned_ak4_btags"]))

# @reg(name="nAK8_btag", nbins=30, xmin=0, xmax=30, unit="", title="nAK8_btag")
# def get_nAK8_btag(ctx)
#     return op.static_cast("Float_t", op.rng_len(ctx.objects["cleaned_ak8_btags"]))
