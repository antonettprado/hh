...
def main(workdir: Path, take_log: bool=False, outfilename: str = None, events:str = None):
    ...
    for tree_name in selections:
        present_vars = REG.get_present_var1D_names(signal_files[0], tree_name)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-o", "--outfilename", default='lr_mappinggs_from_tree', help="Compute LLRs instead of LRs")
    ...
    '''
    To compute LRs:
    python3 bamboo_hh_new/utils/lr_mapping_from_trees.py -w $Z_OUTPUT_eos/JetTop -e even

    To compute LLRs:
    python3 bamboo_hh_new/utils/lr_mapping_from_trees.py -w $Z_OUTPUT_eos/Reco -llr
    '''