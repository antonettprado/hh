...
from bamboo_hh_new.utils.histograms import normalize_hist, get_sum_weights, add_hists
...
if __name__ == '__main__':
    ...
    parser.add_argument("-e", "--events", default='all', help="Event numbers to consider: even or odd or all")
