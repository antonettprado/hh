...
from HH_bbWW_trigger_module import *
...
if __name__ == "__main__":
    ...
    output_dir_name = "hh_bbww_trigger"

    preselection=""
    p=PostProcessor(".",file_list,cut=preselection,branchsel=None,modules=[HH_bbWW_Trigger_Analysis()],noOut=True,histFileName=output_filename,histDirName=output_dir_name)
    p.run()
