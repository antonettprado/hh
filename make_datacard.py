...
if __name__ == "__main__":
    ...
    parser.add_argument("-f", "--cat_disc_filename", action="store", default="datacard_category_discriminant.yml", help="cat_disc_filename = filename for yml file containing categories and discriminants")
