...
HH_bbWW =  cms.EDAnalyzer('HH_bbWW_EDA',
        ...
        min_tau_pT = cms.double(read_yaml.min_tau_pT), ## new
        min_tau_eta = cms.double(read_yaml.min_tau_eta), ## new
        min_fatjet_pT = cms.double(read_yaml.min_fatjet_pT), ## new
        min_fatjet_eta = cms.double(read_yaml.min_fatjet_eta), ## new
        min_ele_tight_sl_pT = cms.double(read_yaml.min_ele_tight_sl_pT), ## remove?
        min_ele_tight_di_pT = cms.double(read_yaml.min_ele_tight_di_pT), ## remove?
        min_mu_tight_sl_pT = cms.double(read_yaml.min_mu_tight_sl_pT), ## remove?
        min_mu_tight_di_pT = cms.double(read_yaml.min_mu_tight_di_pT), ## remove?
        min_jet_tight_pT = cms.double(read_yaml.min_jet_tight_pT), ## remove?
        max_ele_tight_sl_eta = cms.double(read_yaml.max_ele_tight_sl_eta), ## remove?
        max_mu_tight_sl_eta = cms.double(read_yaml.max_mu_tight_sl_eta), ## remove?
        btag_cut_M = cms.double(read_yaml.btag_cut_M), ## change name
        # Additional
        ...
        is_tH = cms.bool(read_yaml.is_tH), ## remove?
        save_gen_info = cms.bool(read_yaml.save_gen_info),
        is_trigger_study = cms.bool(read_yaml.is_trigger_study), ## remove?
        ...
        input_tags = cms.PSet(
            ...
            taus = cms.InputTag("slimmedTaus"), ## new
            jets = cms.InputTag("slimmedJets"),
            fatjets = cms.InputTag("slimmedJetsAK8"), ## new
