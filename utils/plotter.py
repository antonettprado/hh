...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", "--configFile", default='bamboo_hh_new/config/analysis_2022.yml', help="Pick config file within Bamboo_setup/config")
    ...
    Examples of use from script:
        myPlotter = Plotter(dir=Z_OUTPUT/TOTAL_VarsReco_2022, dirtype='workdir', configFile='bamboo_hh_new/config/analysis_2022.yml', eras=[2022, 2022EE])
        myPlotter.Draw_Processes(normalization='unity')
        myPlotter.Draw_Processes(normalization='lumi')

    Example of use from command line:
        python3 bamboo_hh_new/plotter/plotter.py -w Z_OUTPUT/VarsReco -c config/analysis_2022.yml
    '''