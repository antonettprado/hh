...
class L1_Efficiencies(EventSelection):
    def __init__(self, args):
        super(L1_Efficiencies, self).__init__(args)

    def addArgs(self, parser):
        super(L1_Efficiencies, self).addArgs(parser)
    ...
    def set_objects_for_L1(self, tree):
        ...
        objects = self.get_objects(tree, self.era, use_mvaTTH=False, lep_pt_from_L1_or_HLT=self.args.lep_pt)
    ...
    def get_reference_flags(self, sel_name) -> Dict[str, bool]:
    ...
    def get_Mu_seed_emulation(self, seed):
    ...
    def definePlots(self, tree, baseSel, sample=None, sampleCfg=None):
        ...
        if not self.seeds_Mu.empty:
            ...
            L1_Mu_flags_dict = self.get_reference_flags("SL_mu")
        ...
        if not self.seeds_EG.empty:
            ...
            L1_EG_flags_dict = self.get_reference_flags("SL_e")
    ...
    def postProcess(self, taskList, config=None, workdir=None, resultsdir=None):
        super(L1_Efficiencies, self).postProcess(taskList, config=config, workdir=workdir, resultsdir=resultsdir)
