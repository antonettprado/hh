...
class HLT_Effis(NanoAODHistoModule):
    ...
    def definePlots(self, tree, baseSel, sample=None, sampleCfg=None):
        ...
        mllSel = baseSel.refine("mllSel", cut=[selections.mllSel(loose_electrons, loose_muons)])
        ...
        if not paths_Mu.empty:
            ...
            SL_mu = SL_mu_only.refine("SL muon selection", cut=[op.OR(
                sl_res_jet_selection(cleaned_ak4_jets, cleaned_ak4_btags, cleaned_ak8_btags),
