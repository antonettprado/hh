...
def plot_effis(run_dir, path_list):
    ...
    for var in variables:
        ...
        if var == "pt":
            canvas_mu.DrawFrame(0, 0, 200, 1.1, ";Muon p_{T} (GeV);Efficiency")
        elif var == "eta":
        ...
        canvas_e.SetGrid()
        if var == "pt":
            canvas_e.DrawFrame(0, 0, 200, 1.1, ";Electron p_{T} (GeV);Efficiency")
        elif var == "eta":
...
if __name__ == "__main__":
    ...
    '''
    python3 trigger/plot_HLT_trigger_efficiencies_comparison.py -r /eos/user/a/anunezde/Z_OUTPUT_eos/Trigger_Studies_cutAt0 -p SL_mu_HLT_Mu12_IsoVVL_PFHT150_PNetBTag_0p53 SL_e_HLT_Ele14_eta2p5_IsoVVVL_Gsf_HT200_PNetBTag_0p53
    '''