...
def classify_observable(obs_name=None, ref=None) -> ObsInfo:
    """Internal classification function."""
    if ref is not None:
        obs_name = ref.observable
